...
describe('utensils', () => {
    ...
    describe('spoons', () => {
        ...
        it('should convert US tablespoons to US fluid ounces', () => {
            ...
            const usFluidOunces =  repository.findAndConvert(new UnitIdentifier(domains.Volume, UnitedStates, Utensils, 'tablespoon'), usTableSpoons, new UnitIdentifier(domains.Volume, UnitedStates, Customary, 'fluid ounce'))
            expect(usFluidOunces.valueOf()).toBe(1)
        })

        it('should convert UK tablespoons to millilitres', () => {
            const ukTableSpoons = 1
            const millilitres =  repository.findAndConvert(new UnitIdentifier(domains.Volume, UnitedKingdom, Utensils, 'tablespoon'), ukTableSpoons, new UnitIdentifier(domains.Volume, SystemInternational, Metric, 'millilitre'))
            expect(millilitres.valueOf()).toBe(15)
        })

        it('should convert US tablespoons to millilitres', () => {
            const usTableSpoons = 1
            const millilitres =  repository.findAndConvert(new UnitIdentifier(domains.Volume, UnitedStates, Utensils, 'tablespoon'), usTableSpoons, new UnitIdentifier(domains.Volume, SystemInternational, Metric, 'millilitre'))
            expect(millilitres.valueOf()).toBe(14.78676478125)
        })
        
        it('should convert US tablespoons to UK tablespoons', () => {
            const usTableSpoons = 1
            const ukTableSpoons =  repository.findAndConvert(new UnitIdentifier(domains.Volume, UnitedStates, Utensils, 'tablespoon'), usTableSpoons, new UnitIdentifier(domains.Volume, UnitedKingdom, Utensils, 'tablespoon'))
    ...
    describe('cups', () => {
        ...
        it('should convert US cups to UK cups', () => {
            const usCups = 1
            const ukCups =  repository.findAndConvert(new UnitIdentifier(domains.Volume, UnitedStates, Utensils, 'cup'), usCups, new UnitIdentifier(domains.Volume, UnitedKingdom, Utensils, 'cup'))
